...
def decoding(secret_mes, start, end, iteration):
    return secret_mes[start:end:iteration]

def task_8():
    secret_message_first = decoding(secret_message[0], 3, 4, 1)
    secret_message_second = decoding(secret_message[1], 9, 13, 1)
    secret_message_third = decoding(secret_message[2], 5, 15, 2)
    secret_message_fourth = decoding(secret_message[3], 12, 6, -1)
    secret_message_fifth = decoding(secret_message[4], 20, 15, -1)
